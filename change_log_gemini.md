...
| 2026-03-02 | README Update & DB Cleanup | `README.md`, `Database/updates/update_149_remove_experimental_mode.sql` | Updated README with 1.4.8 Restoration Plan, ServerLauncher instructions, and developer links. Removed orphaned ExperimentalMode database elements. |
