...
namespace WorldServer.Managers.Commands
{
    ...
    public class CommandDeclarations
    {
        ...
        // Mapped from old bitmask flags to closest sequential tier.
        ...
        public static List<GmCommandHandler> AbilityCommands = new List<GmCommandHandler>
        {
            ...
            new GmCommandHandler("addstat", AddStatBonus, null, EGmLevel.Developer, 2, "Increases a given stat by a given value."),
            new GmCommandHandler("buff", SendBuffAppearance, null, EGmLevel.Developer, 1, "Sends a fake buff start packet (int buffId)"),
            new GmCommandHandler("effect", SendCastPlayerEffect, null, EGmLevel.Developer, 2, "Sends a cast player effect packet."),
            new GmCommandHandler("start", SendCastPlayerStart, null, EGmLevel.Developer, 2, "Sends a buff effect start packet."),
            new GmCommandHandler("end", SendCastPlayerEnd, null, EGmLevel.Developer, 2, "Send a buff effect end packet."),
            new GmCommandHandler("send", SendTestAbility, null, EGmLevel.Developer, 1, "Send an ability to the client."),
            new GmCommandHandler("cast", InvokeAbility, null, EGmLevel.Developer, 1, "If possible, casts the ability of the specified ID."),
            new GmCommandHandler("buffcast", InvokeBuff, null, EGmLevel.Developer, 2, "Invokes the buff of the specified ID."),
            new GmCommandHandler("zerostats", SendZeroStats, null, EGmLevel.Developer, 0, "Sends zero stats to the client for debug purposes."),
        ...
        {
            new GmCommandHandler("item", AddItem, null, EGmLevel.GM, 1, "Add item to player"),
            new GmCommandHandler("money", AddMoney, null, EGmLevel.Developer, 1, "Add money to player"),
            new GmCommandHandler("tok", AddTok, null, EGmLevel.GM, 1, "Add tok to player"),
            new GmCommandHandler("renown", AddRenown, null, EGmLevel.GM, 1, "Add renown to player"),
            new GmCommandHandler("influence", AddInf, null, EGmLevel.GM, 1, "Add Influence to player"),
            new GmCommandHandler("xp", AddXp, null, EGmLevel.GM, 1, "Add xp to player"),
            new GmCommandHandler("eligibility", AddRewardEligibility, null, EGmLevel.GM, 0, "Reports on players eligibility"),
            new GmCommandHandler("zonelockbags", AddZoneLockBags, null, EGmLevel.GM, 0, "Adds Zone Lock Bags"),
        };
        ...
        {
            new GmCommandHandler("save", ChapterSave, null, EGmLevel.Developer, 1, "Save chapter position"),
            new GmCommandHandler("explore", ChapterTokExplore, null, EGmLevel.Developer, 2, "Set tok explore"),
            new GmCommandHandler("tokentry", ChapterTok, null, EGmLevel.Developer, 2, "Set tok entry")
        };
        ...
        {
            new GmCommandHandler("groups", CheckGroups, null, EGmLevel.Developer, 0, "Check how many groups exist on the server."),
            new GmCommandHandler("objects", CheckObjects, null, EGmLevel.Developer, 0, "Check how many objects exist in the current region."),
            new GmCommandHandler("players", CheckPlayersInRange, null, EGmLevel.GM, 0, "Finds all players currently in range."),
            new GmCommandHandler("respawn", FindClosestRespawn, null, EGmLevel.Developer, 0, "Find the closest respawn point for the specified realm."),
            new GmCommandHandler("logpackets", LogPackets, null, EGmLevel.Developer, 0, "Toggles logging outgoing packet volume."),
            new GmCommandHandler("readpackets", ReadPackets, null, EGmLevel.Developer, 0, "Displays the volume of outgoing packets over the defined period."),
        ...
        {
            new GmCommandHandler("itemsreload", ReloadItems, null, EGmLevel.Developer, 0, "Reload items information"),
            new GmCommandHandler("characterreload", ReloadCharacter, null, EGmLevel.Developer, 0, "Reload character <name>"),
            new GmCommandHandler("creaturesreload", ReloadCreatures, null, EGmLevel.Developer, 0, "Reload creatures in your region"),
            new GmCommandHandler("gameobjectsreload", ReloadGameObjects, null, EGmLevel.Developer, 0, "Reload game objects in your region"),
            new GmCommandHandler("reloadabilities", ReloadAbilities, null, EGmLevel.Developer, 0, "Reload abilities."),
            new GmCommandHandler("reloadpetmodifiers", ReloadPetModifiers, null, EGmLevel.Developer, 0, "Reload pet modifiers")
        ...
        {
            new GmCommandHandler("add", EquipAdd, null, EGmLevel.Developer, 3, "Add Equipement to target <Model,Slot,Save>"),
            new GmCommandHandler("remove", EquipRemove, null, EGmLevel.Developer, 2, "Remove Equipement to target <Slot,Save>"),
            new GmCommandHandler("clear", EquipClear, null, EGmLevel.Developer, 1, "Remove All Equipements to target <Save>"),
        ...
        {
            new GmCommandHandler("doorinfo", DoorInfo, null, EGmLevel.Staff, 0, "Returns LOS information about keep door"),
            new GmCommandHandler("info", InIinfo, null, EGmLevel.Staff, 0, "instance infos optional: <instanceid>"),
            new GmCommandHandler("spawn", InISpawn, null, EGmLevel.Developer, 4, "Spawn a Instance NPC <object id> <BossId> <spawngroup> <realm>"),
            new GmCommandHandler("convert", InstanceConvert, null, EGmLevel.Developer, 3, "Converts selected Object to a Instance spawn <BossId> <spawngroup> <realm>"),
            new GmCommandHandler("bossspawn", InIBossSpawn, null, EGmLevel.Developer, 4, "Spawn a Instance Boss NPC <object id> <BossId> <spawngroup> <instanceid>"),
            new GmCommandHandler("bossconvert", InstanceBossConvert, null, EGmLevel.Developer, 3,
                "Converts selected Object to a Instance Boss spawn <BossId> <spawngroup> <instanceid>"),
            new GmCommandHandler("reset", InstanceReset, null, EGmLevel.Developer, 0, "Resets the current pq"),
            new GmCommandHandler("opendoor", InstanceOpenDoor, null, EGmLevel.Developer, 0, "Opens door inside instance (uniqueID, instanceID, open=1/close=0)"),
        ...
        public static List<GmCommandHandler> ModifyCommands = new List<GmCommandHandler>
        {
            ...
            new GmCommandHandler("playernametemp", ModifyPlayerNameTemp, null, EGmLevel.GM, 0, "Temporarily changes players name until server restart."),
            new GmCommandHandler("guildleader", ModifyGuildLeader, null, EGmLevel.GM, 2, "Changes the leader of the guild (string newLeader, string guildName)"),
            new GmCommandHandler("guildnamebyid", ModifyGuildNameByID, null, EGmLevel.GM, 2, "Changes the name of the guild by ID (int guildID string guildName)"),

            new GmCommandHandler("level", ModifyLevel, null, EGmLevel.Admin, 1, "Changes the level of the targeted player (int Rank)"),
            new GmCommandHandler("renown", ModifyRenown, null, EGmLevel.Admin, 2, "Changes the renown rank of a player (string playerName, int RenownRank)"),
            new GmCommandHandler("stat", ModifyStat, null, EGmLevel.Developer, 2, "Changes your proficiency in your current crafting skill (byte Skill)"),
            new GmCommandHandler("access", ModifyAccess, null, EGmLevel.Admin, 1, "Changes the access level of the designated account (string username, int newAccessLevel)"),
            new GmCommandHandler("morale", ModifyMorale, null, EGmLevel.Developer, 1, "Changes the morale of the selected player (int Morale)"),
            new GmCommandHandler("faction", ModifyFaction, null, EGmLevel.Developer, 1, "Changes the current faction of selected Unit (byte Faction)"),
            new GmCommandHandler("influence", ModifyInf, null, EGmLevel.Developer, 1, "Change the Influence Chaptter Value"),
            new GmCommandHandler("resource", ModifyCrrRes, null, EGmLevel.Developer, 1, "Modify your career resource value (byte careerResource)"),
        ...
        {
            new GmCommandHandler("set", SetMountCommand, null, EGmLevel.GM, 1, "Changes the mount of the selected unit (int Entry)"),
            new GmCommandHandler("add", AddMountCommand, null, EGmLevel.Developer, 3, "Adds a new mount to the database (int Entry, int Speed, string Name)"),
            new GmCommandHandler("remove", RemoveMountCommand, null, EGmLevel.GM, 0, "Removes the mount of the selected unit."),
        ...
        public static List<GmCommandHandler> NpcCommands = new List<GmCommandHandler>
        {
            ...
            new GmCommandHandler("spawn",NpcSpawn, null, EGmLevel.Developer, 1, "Spawn an npc"),
            new GmCommandHandler("remove",NpcRemove, null, EGmLevel.Developer, 1, "Delete the target <(0=World,1=Database)>"),
            new GmCommandHandler("go",NpcGoTo, null, EGmLevel.Developer, 3, "Npc Go To Target <X,Y,Z>"),
            new GmCommandHandler("come",NpcCome, null, EGmLevel.Developer, 0, "Move target to my position"),
            new GmCommandHandler("modify",NpcModify, null, EGmLevel.Developer, 2, "Modify a column value <columnname,value,0 target- 1 all>"),
            new GmCommandHandler("quote",NpcQuote, null, EGmLevel.Developer, 1, "Adds speech to the targeted NPC, by spawn (string text)"),
            new GmCommandHandler("tint",NpcTint, null, EGmLevel.Developer, 3, "Sets armor piece color <slotIndex (0=all), pri_tint, sec_tint (from tintpalette_equipment.csv)>"),
            new GmCommandHandler("animscript", NpcAnimScript, null, EGmLevel.Developer, 1, "Sets monster's animation script <animID> (animID from anim_scripts.csv. 0 to remove)."),
            new GmCommandHandler("animationset", NpcPermaAnimScript, null, EGmLevel.Developer, 1, "Sets monster's animation script <animID> (animID from anim_scripts.csv. 0 to remove). This is permanent, updates DB."),
            new GmCommandHandler("level",NpcLevel, null, EGmLevel.Developer, 1, "Sets NPC Level to specified value"),
            new GmCommandHandler("disable",NpcDisable, null, EGmLevel.Developer, 0, "Disables NPC from spawns. Can be restored using the DB."),
            new GmCommandHandler("move",NpcChangeSpawnPlace, null, EGmLevel.Developer, 0, "Makes NPC come to player and updates his position in DB."),
            new GmCommandHandler("addtoevent",NpcEventConvert, null, EGmLevel.Developer, 1, "Adds NPC to event. Currently doesn't work."),
            new GmCommandHandler("health",NpcHealth, null, EGmLevel.Developer, 1, "Sets NPC or GO health to specified value percent."),
            new GmCommandHandler("keepspawn",NpcKeepSpawn, null, EGmLevel.Developer, 1, "Spawn an keep npc <destroId> <orderId> <keepId (0 for auto)>"),
            new GmCommandHandler("keepnpcmove",MoveKeepSpawn, null, EGmLevel.Developer, 1, "Moves an keep npc"),
        };
        ...
        public static List<GmCommandHandler> PqCommands = new List<GmCommandHandler>
        {
            ...
            new GmCommandHandler("add", PqSpawn, null, EGmLevel.Developer, 3, "Spawn a PQ NPC <object id> <objective id> <type 1 = NPC>"),
            new GmCommandHandler("convert", PqConvert, null, EGmLevel.Developer, 1, "Converts selected Object to a PQ spawn <objective id>"),
        ...
        {
            new GmCommandHandler("add", RespawnAdd, null, EGmLevel.Developer, 0, "Add respawn point to your position <1=Order or 2=Destruction>"),
            new GmCommandHandler("modify", RespawnModify, null, EGmLevel.Developer, 1, "Modify existing point to you position <ID>"),
            new GmCommandHandler("remove", RespawnRemove, null, EGmLevel.Developer, 1, "Delete existing point <ID>")
        };
        ...
        {
            new GmCommandHandler("gathering", RespecGathering, null, EGmLevel.Developer, 0, "Respec Gathering Skill"),
            new GmCommandHandler("crafting", RespecCrafting, null, EGmLevel.Developer, 0, "Respec Crafting Skill"),
            new GmCommandHandler("mastery", MasteryRespecialize, null, EGmLevel.Staff, 0, "Resets your career mastery points.")
        };
        ...
        {
            new GmCommandHandler("balance", CheckBalance, null, EGmLevel.Developer, 0, "Checks the current scenario's balance internals."),
            new GmCommandHandler("domination", CheckDomination, null, EGmLevel.Developer, 0, "Checks the current scenario's domination internals.")

            // new GmCommandHandler("rotate", ScenarioRotate, null, EGmLevel.GM, 0, "Rotates the active scenarios.")
        };
        ...
        {
            new GmCommandHandler("add", StatesAdd, null, EGmLevel.Developer, 1, "Add State To Target <Id>"),
            new GmCommandHandler("remove", StatesRemove, null, EGmLevel.Developer, 1, "Remove state from target <Id>"),
        ...
        {
            new GmCommandHandler("listtickets", ListTickets, null, EGmLevel.Developer, 0, "Lists the current tickets"),
            new GmCommandHandler("assign", Assign, null, EGmLevel.Developer, 2, "Assigns a person to a ticket (string accountname, string bugreportID)"),
            new GmCommandHandler("assignme", AssignMe, null, EGmLevel.Developer, 1, "Assigns a person to a ticket (string bugreportID)"),
            new GmCommandHandler("numberoftickets", NumberOfTickets, null, EGmLevel.Developer, 0, "Shows how many tickets there currently is"),
            new GmCommandHandler("deleteticket", DeleteTicket, null, EGmLevel.Developer, 1, "Deletes the ticket (string bugreportID)"),
            new GmCommandHandler("answer", Answer, null, EGmLevel.Developer, 2, "Answers and closes a ticket (string reportID, string message)")
        };
        ...
        public static List<GmCommandHandler> WaypointCommands = new List<GmCommandHandler>
        {
            ...
            new GmCommandHandler("add", NpcAddWaypoint, null, EGmLevel.Developer, 0, "Adds a waypoint on your current position to your current target."),
            new GmCommandHandler("remove", NpcRemoveWaypoint, null, EGmLevel.Developer, 1, "Remove a waypoint from the target (int Id)"),
            new GmCommandHandler("move", NpcMoveWaypoint, null, EGmLevel.Developer, 1, "Moves the specified waypoint of target to your position (int Id)"),
            new GmCommandHandler("list", NpcListWaypoint, null, EGmLevel.Developer, 0, "Shows the list of waypoints."),
            new GmCommandHandler("info", NpcInfoWaypoint, null, EGmLevel.Developer, 0, "Shows information about the current waypoint.")
        };
        ...
        public static List<GmCommandHandler> BaseCommand = new List<GmCommandHandler>
        {
            ...
            new GmCommandHandler("database", null, DatabaseCommands, EGmLevel.Developer, 0, "Database commands."),
            ...
            new GmCommandHandler("pq", null, PqCommands, EGmLevel.Developer, 0, "Public Quest commands."),
            new GmCommandHandler("respawn", null, RespawnCommands, EGmLevel.Developer, 0, "Respawn modification commands."),
            new GmCommandHandler("respec", null, RespecCommands, 0, 0, "Respecialization commands."),
            new GmCommandHandler("scenario", null, ScenarioCommands, EGmLevel.Staff, 0, "Scenario commands."),
            new GmCommandHandler("search", null, SearchCommands, EGmLevel.GM, 0, "Search commands."),
            new GmCommandHandler("states", null, StatesCommand, EGmLevel.Developer, 0, "State modification commands."),
            ...
            new GmCommandHandler("waypoints", null, WaypointCommands, EGmLevel.Developer, 0, "Waypoint commands."),
            new GmCommandHandler("setting", null, SettingCommands, EGmLevel.Developer, 0, "World settings commands."),
            ...
            new GmCommandHandler("ping", GetPing, null, EGmLevel.Developer, 0, "Shows player ping."),
            ...
            new GmCommandHandler("gmcommands", GmCommands, null, EGmLevel.GM, -1, "Lists available GM commands and explains them. Usage: .gmcommands <command path> [--long]"),
            ...
            // All staff
#if (DEBUG)
            new GmCommandHandler("debugmode", SetDebugMode, null, EGmLevel.Developer, 0, "Enables debugging messages (byte enableDebug)"),
#else
            new GmCommandHandler("debugmode", SetDebugMode, null, EGmLevel.Staff, 0, "Enables debugging messages (byte enableDebug)"),
            #endif
            ...
            new GmCommandHandler("prevpos", PreviousPosition, null, EGmLevel.Staff, 1,
                "Creates an object at the position which a player held a certain time ago (int millisecondDelta)"),
            new GmCommandHandler("latency", OverrideLatency, null, EGmLevel.Staff, 1, "Overrides the server's opinion of your latency (int latency)"),
            new GmCommandHandler("getguildlead", GetGuildLead, null, EGmLevel.Staff, 1, "Returns the guild leader of the guild specified (string guildname)"),
            ...
            new GmCommandHandler("nuke", Nuke, null, EGmLevel.GM, 2,
                "Slays everyone in radius. Takes 2 parameters, realm and radius in ft. Realm 0 - all, 1 - order, 2 - destro"),

            new GmCommandHandler("boot", Reboot, null, EGmLevel.Admin, 0, "Cleanly shuts the server down: saves all data, kicks all players, then exits."),
            ...
            new GmCommandHandler("invmob", Invincible, null, EGmLevel.GM, 0, "Toggles invulnerability on the character."),
            new GmCommandHandler("xpmode", XpMode, null, EGmLevel.GM, 0, "Allows you to cease gaining experience points (byte Enabled)"),
            new GmCommandHandler("gps", Gps, null, EGmLevel.GM, 0, "Prints information about your current target's position."),
            new GmCommandHandler("setnpcmodel", SetNpcModel, null, EGmLevel.GM, 1, "Temporary overlays npc model on selected target. To clear set modelID to 0."),
            new GmCommandHandler("setvfxstate", SetVfxState, null, EGmLevel.GM, 2, "Set game objects effect state (ushort objectID, byte vfxID)"),
            new GmCommandHandler("getobjects", GetObjects, null, EGmLevel.GM, 0, "List OIDs of all game objects in range"),
            new GmCommandHandler("effectstate", SetEffectState, null, EGmLevel.Developer, 1,
            ...
            new GmCommandHandler("packet2", Packet2, null, EGmLevel.GM, 1, "Custom command to check how one variable works."),
            ...
            new GmCommandHandler("annihilate", Annihilate, null, EGmLevel.GM, 1, "Wipes the player's account, after asking for confirmation (string accountName)"),
            new GmCommandHandler("getcharslots", GetCharSlots, null, EGmLevel.GM, 1,
            ...
            new GmCommandHandler("listblockednames", ListBlockedNames, null, EGmLevel.GM, 0, "Lists all blocked names"),
            new GmCommandHandler("removequests", RemoveQuests, null, EGmLevel.GM, 1, "Removes all the quests from a player (string player)"),
            new GmCommandHandler("hide", Hide, null, EGmLevel.GM, 0, "Hides you from the gmlist"),

            // Database dev commands

            new GmCommandHandler("playeffect", PlayEffect, null, EGmLevel.Developer, 2, "Play effect from data/gamedata/effectlist.csv"),
            new GmCommandHandler("playability", PlayAbility, null, EGmLevel.Developer, 2, "Plays ability from data/gamedata/effect.csv (string playerName, ushort effectID)"),
            new GmCommandHandler("playsound", PlaySound, null, EGmLevel.Developer, 1,
            ...
            new GmCommandHandler("save", Save, null, EGmLevel.Developer, 0, "Performs a database save on the target."),
            new GmCommandHandler("objectivestate", ObjectiveState, null, EGmLevel.Developer, 1, "Set vfx for objective (int oid)."),
            new GmCommandHandler("previewmodel", PreviewItemModel, null, EGmLevel.GM, 1, "Temporary sets equipped item model (int slotIndex, int modelID)"),
            new GmCommandHandler("recreateplayer", CreatePlayer, null, EGmLevel.Developer, 1, "Requests player info is resent"),
            new GmCommandHandler("quest", QuestComplete, null, EGmLevel.Developer, 2,
                "Used to debug quests <QuestId> <Operation> Operation 1 - add, 2 - finish quest, 3 - delete quest from player"),
            new GmCommandHandler("givebag", GiveBag, null, EGmLevel.Developer, 0,
            ...
            // Source dev commands
            new GmCommandHandler("lockcasting", PreventCasting, null, EGmLevel.Developer, 0, "Prevents all casting (byte blockAllCasts)"),
            new GmCommandHandler("mindread", MindRead, null, 0, 0, "Causes the target creature to broadcast its AI."),
            new GmCommandHandler("collatelength", SetCollationLength, null, EGmLevel.Developer, 1,
            ...
            new GmCommandHandler("scenariocmd", ScenarioCmd, null, EGmLevel.Developer, 0, "Send custom command into scenario handler."),
            new GmCommandHandler("scout", ScoutChamps, null, EGmLevel.Developer, 0, "Scouts for champions in the current region."),
            new GmCommandHandler("alltoks", AllTok, null, EGmLevel.Developer, 1, "enable all toks"),
            new GmCommandHandler("packetlog", PacketLog, null, EGmLevel.Developer, 1, "Turns on packet logging for player's account (string playername)"),
            new GmCommandHandler("tokbestiary", AllTokBestiary, null, EGmLevel.Developer, 1, "enable all toks"),
            new GmCommandHandler("guildlogon", LogGuild, null, EGmLevel.Developer, 1, "Log chat of a particular guild."),
            new GmCommandHandler("guildlogoff", CancelLogGuild, null, EGmLevel.Developer, 1, "Cease logging chat of a particular guild."),
            new GmCommandHandler("structure", CreateRvRObject, null, EGmLevel.Developer, 0, "Creates a structure."),
            new GmCommandHandler("bolsterlevel", BolsterLevel, null, EGmLevel.Developer, 1, "Changes max bolster level for T2 T3 and T4."),
            new GmCommandHandler("playerdrop", ChangePlayerDrop, null, EGmLevel.Developer, 1, "Switch that changes how medallions are generated for killed players."),
            new GmCommandHandler("beastmaster", Beastmaster, null, EGmLevel.Developer, 0, "Changes your whitelion to beastmaster."),
            new GmCommandHandler("setpet", SetPet, null, EGmLevel.Developer, 1, "Changes your pet model to number provided."),
            new GmCommandHandler("summonpet", SummonPet, null, EGmLevel.Developer, 1, "Summons the pet requested."),
            new GmCommandHandler("spawnmobinstance", SpawnMobInstance, null, EGmLevel.Developer, 1, "Spawns one or more mobs (does not save to db)"),
            new GmCommandHandler("sendkeepinfo", SendKeepInfoWrapper, null, EGmLevel.Developer, 0, "Sends a KeepInfo message"),
            new GmCommandHandler("sendkeepstatus", SendKeepStatusWrapper, null, EGmLevel.Developer, 0, "Sends a KeepInfo message"),
            new GmCommandHandler("sendcampaignstatus", SendCampaignStatusWrapper, null, EGmLevel.Developer, 0, "Sends a Campaign Status message"),
            new GmCommandHandler("dynamicvendor", CreateDynamicVendor, null, EGmLevel.Developer, 0, "Creates a dynamic vendor"),
            new GmCommandHandler("creategatehouseportal", CreateGateHousePortal, null, EGmLevel.Developer, 0, "Creates a portal to Southern Garrison gatehouse"),
            new GmCommandHandler("realmcaptain", MakeRealmCaptain, null, EGmLevel.Developer, 0, "Makes the targetted player a realm captain"),
            new GmCommandHandler("spawnboss", SpawnBossInstance, null, EGmLevel.Developer, 1, "Spawns a boss <protoid>"),
            new GmCommandHandler("summongoremane", SummonGoremane, null, EGmLevel.Developer, 0, "Spawns Goremane"),
            new GmCommandHandler("summonkokrit", SummonKokrit, null, EGmLevel.Developer, 0, "Spawns Kokrit"),
            new GmCommandHandler("summonbulbousone", SummonBulbousOne, null, EGmLevel.Developer, 0, "Spawns the Bulbous One"),
            new GmCommandHandler("summonazukthul", SummonAzukThul, null, EGmLevel.Developer, 0, "Spawns AzukThul"),
            new GmCommandHandler("summonborzhar", SummonBorzhar, null, EGmLevel.Developer, 0, "Spawns Borzhar"),
            new GmCommandHandler("summongahlvoth", SummonGahlvoth, null, EGmLevel.Developer, 0, "Spawns Gahlvoth"),
            new GmCommandHandler("summonzekaraz", SummonZekaraz, null, EGmLevel.Developer, 0, "Spawns Zekaraz"),
            new GmCommandHandler("summonlordslaurith", SummonLordSlaurith, null, EGmLevel.Developer, 0, "Spawns LordSlaurith"),
            ...
            new GmCommandHandler("bulkmail", BulkMailItems, null, EGmLevel.Developer, 1, "Mail items from a file to characters"),
