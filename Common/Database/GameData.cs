...
namespace GameData
{
    ...
    public enum CareerLine
    {
        ...
        CAREERLINE_KNIGHT_OF_THE_BLAZING_SUN = 10,
        CAREERLINE_KNIGHT = CAREERLINE_KNIGHT_OF_THE_BLAZING_SUN,
        CAREERLINE_BRIGHT_WIZARD = 11,
        CAREERLINE_WARRIOR_PRIEST = 12,

        CAREERLINE_CHOSEN = 13,
        CAREERLINE_MARAUDER = 14,
        CAREERLINE_WARRIOR = CAREERLINE_MARAUDER,
        CAREERLINE_ZEALOT = 15,
        CAREERLINE_MAGUS = 16,

        CAREERLINE_SWORDMASTER = 17,
        CAREERLINE_SHADOW_WARRIOR = 18,
        CAREERLINE_WHITE_LION = 19,
        CAREERLINE_WHITELION = CAREERLINE_WHITE_LION,
        CAREERLINE_ARCHMAGE = 20,

        CAREERLINE_BLACK_GUARD = 21,
        CAREERLINE_BLACKGUARD = CAREERLINE_BLACK_GUARD,
        CAREERLINE_WITCH_ELF = 22,
        CAREERLINE_WITCHELF = CAREERLINE_WITCH_ELF,
        CAREERLINE_DISCIPLE_OF_KHAINE = 23,
        CAREERLINE_DISCIPLE = CAREERLINE_DISCIPLE_OF_KHAINE,
