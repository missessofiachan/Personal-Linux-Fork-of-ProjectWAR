...
namespace Niflib
{
    ...
    public class NiGeometry : NiAVObject
	{
        ...
        /// <summary>
        /// Tracks the 20.2.0.7+ default-material update flag.
        /// </summary>
        public byte DefaultMatNeedsUpdateFlag;
        ...
        public NiGeometry(NiFile file, BinaryReader reader) : base(file, reader)
		{
			...
			if (base.Version >= eNifVersion.v3_3_0_13)
			{
				this.SkinInstance = new NiRef<NiSkinInstance>(reader);
			}
			if (base.Version >= eNifVersion.v20_2_0_5)
			{
			...
			else if (base.Version >= eNifVersion.v10_0_1_0 && base.Version <= eNifVersion.v20_1_0_3)
			{
			...
			if (base.Version == eNifVersion.v10_4_0_1)
			{
				reader.ReadUInt32();
			}
			if (base.Version >= eNifVersion.v20_2_0_7)
			{
                this.DefaultMatNeedsUpdateFlag = reader.ReadByte();
			}
		}
	}
}
