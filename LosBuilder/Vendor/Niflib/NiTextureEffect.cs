...
namespace Niflib
{
    ...
    public class NiTextureEffect : NiDynamicEffect
    {
        ...
        public NiTextureEffect(NiFile file, BinaryReader reader) : base(file, reader)
        {
            ...
            if (base.Version <= eNifVersion.v3_1)
            {
                throw new Exception("NOT SUPPORTED!");
            }
            if (base.Version >= eNifVersion.v4_0_0_0)
            {
            ...
            if (this.File.Header.Version <= eNifVersion.v10_2_0_0)
            {
                this.PS2L = reader.ReadInt16();
                this.PS2K = reader.ReadInt16();
            }
            if (this.File.Header.Version <= eNifVersion.v4_1_0_12)
            {
